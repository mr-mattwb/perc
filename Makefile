...
MODS=tools lex propBase iniLex propLex ser fileOps envParam env log dayTime time date dateTime soxi pLog
ML=tools.ml lex.ml propBase.ml iniParse.ml iniLex.ml propParse.ml propLex.ml ser.ml fileOps.ml envParam.ml env.ml log.ml dayTime.ml time.ml date.ml dateTime.ml soxi.ml pLog.ml
PERCML=perc5sWav.ml percCfg.ml
MLI=tools.mli ser.mli fileOps.mli envParam.mli env.mli log.mli dayTime.mli time.mli date.mli dateTime.mli soxi.mli pLog.mli
